...
export class CanvasLocal {
  ...
  drawHexface(x1: number, y1: number, width: number, height: number, r: number, g: number, b: number): void{
   ...
   drawHexfaceTapa(x1: number, y1: number, width: number, height: number, r: number, g: number, b: number): void{
    let unidad = width;
  ...
  for (let i = 1; i <= 8; i += 2) {
      ...
      this.drawHexface(this.iX(i), this.iY(6 * h[ind] / maxEsc), this.iX(1) - this.iX(0),
        ...
        this.drawHexfaceTapa(this.iX(i), this.iY(6 * h[ind] /maxEsc-0.2), this.iX(1) - this.iX(0),
        this.iY( 6* h[ind] / maxEsc-0.1) - this.iY(0), r, g, b);
